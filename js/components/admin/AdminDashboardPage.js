...
import AdminUpdates from "./AdminUpdates.js";
...
const Icons = {
    ...
    upload: () => h("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", "stroke-width": "2", "stroke-linecap": "round", "stroke-linejoin": "round" },
...
export default class AdminDashboardPage extends Component {
    constructor() {
        ...
        this.sections = [
            ...
            { id: "updates", label: "App Updates", icon: Icons.upload },
        ];
    }
